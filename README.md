# BlockingMachine
- Use this tool to block ads and trackers
- If you find any issues, be sure to create an [issue](https://github.com/Greigh/BlockingMachine/issues).
...
### Sources Used
 - My own closed source filter that filters out ads, trackers, false positives (mostly created from the lists below), and other annoying stuff.
 - [d3ward Basic List](https://raw.githubusercontent.com/d3ward/toolz/master/src/d3host.adblock)
 ...
 - [dGuard Home Whitelist](https://raw.githubusercontent.com/hl2guide/AdGuard-Home-Whitelist/main/whitelist.txt)
 ...
 - And [more](https://github.com/Greigh/BlockingMachine/blob/master/hostlist-compiler-config.json)! 
    


## How to use
1. Get the [RAW format](https://raw.githubusercontent.com/Greigh/BlockingMachine/master/BlockingMachine)
2. Copy the URL.
3. Paste it into your filter of your choice.
    - AdBlock Plus
    - AdGuard [Home]
    - PiHole (Only uses Host file syntax, I recommend using [AdGuard Home](https://adguard.com/en/adguard-home/overview.html))
    - uBlock Origin
4. It should update as I push updates
    - Just make sure you are updating your filters regularly.
    - Updates don't come everyday.
