          ...
          <ul className="contact-list">
            <li>
              <span className="contact-icon">
                {/* Globe SVG */}
                <svg width="20" height="20" fill="none" viewBox="0 0 24 24"><circle cx="12" cy="12" r="10" stroke="currentColor" strokeWidth="2"/><ellipse cx="12" cy="12" rx="4" ry="10" stroke="currentColor" strokeWidth="2"/><line x1="2" y1="12" x2="22" y2="12" stroke="currentColor" strokeWidth="2"/></svg>
              </span>
              <a href="https://danielhipskind.com" target="_blank" rel="noopener noreferrer">
                danielhipskind.com
              </a>
            </li>
            <li>
              ...
              <a href="https://github.com/greigh/blockingmachine" target="_blank" rel="noopener noreferrer">
            ...
            <li>
              <span className="contact-icon">
                {/* Twitter SVG */}
                <svg width="20" height="20" fill="none" viewBox="0 0 24 24"><path fill="currentColor" d="M22.46 6c-.77.35-1.6.58-2.47.69a4.3 4.3 0 0 0 1.88-2.37 8.59 8.59 0 0 1-2.72 1.04A4.28 4.28 0 0 0 16.11 4c-2.37 0-4.29 1.92-4.29 4.29 0 .34.04.67.11.99C7.69 9.13 4.07 7.38 1.64 4.7c-.37.64-.58 1.38-.58 2.17 0 1.5.76 2.82 1.92 3.6-.7-.02-1.36-.21-1.94-.53v.05c0 2.1 1.5 3.85 3.5 4.25-.36.1-.74.16-1.13.16-.28 0-.54-.03-.8-.08.54 1.7 2.1 2.94 3.95 2.97A8.6 8.6 0 0 1 2 19.54c-.29 0-.57-.02-.85-.05A12.13 12.13 0 0 0 8.29 21c7.55 0 11.68-6.26 11.68-11.68 0-.18-.01-.36-.02-.54A8.18 8.18 0 0 0 22.46 6z"/></svg>
              </span>
              <a href="https://twitter.com/danielhipskind_" target="_blank" rel="noopener noreferrer">
                @danielhipskind_
              </a>
            </li>
            <li>
              <span className="contact-icon">
                ...
                <svg width="20" height="20" viewBox="0 0 24 24" fill="none">
                  ...
                  <path d="M17.5 10.5c0 2.5-.5 4-1.5 5s-2.5 1.5-4 1.5-3-.5-4-1.5-1.5-2.5-1.5-5V8.5c0-1 .5-1.5 1.5-1.5h8c1 0 1.5.5 1.5 1.5v2z" fill="#fff"/>
                  <ellipse cx="9.5" cy="12" rx="1" ry="1.5" fill="#6364FF"/>
                  <ellipse cx="14.5" cy="12" rx="1" ry="1.5" fill="#6364FF"/>
                </svg>
              </span>
              <a href="https://mastodon.social/@danielhipskind" target="_blank" rel="me noopener noreferrer">
            ...
            <li>
              <span className="contact-icon">
                ...
                <svg width="20" height="20" viewBox="0 0 24 24" fill="none">
                  ...
                  <path d="M7 13c2 2 8 2 10 0" stroke="#fff" strokeWidth="2" strokeLinecap="round"/>
                  <circle cx="9" cy="10" r="1" fill="#fff"/>
                  <circle cx="15" cy="10" r="1" fill="#fff"/>
                </svg>
              </span>
              <a href="https://bsky.app/profile/danielhipskind" target="_blank" rel="noopener noreferrer">
                @danielhipskind.com
              </a>
            </li>
            <li>
              <span className="contact-icon">
                ...
                <svg width="20" height="20" fill="none" viewBox="0 0 24 24">
                  <rect x="3" y="5" width="18" height="14" rx="3" stroke="#007bff" strokeWidth="2" fill="#fff"/>
                  <path d="M3 7l9 6 9-6" stroke="#007bff" strokeWidth="2" fill="none"/>
                </svg>
              </span>
